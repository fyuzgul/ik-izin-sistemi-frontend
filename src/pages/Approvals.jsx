      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:items-start">
          {(user?.roleName === 'Yönetici' || user?.roleName === 'Admin') && (
            <div className="bg-gradient-to-br from-gray-900 via-gray-800 to-black rounded-2xl shadow-2xl p-8 border border-gray-700 hover:border-gray-600 transition-all duration-300 flex flex-col max-h-[800px]">
